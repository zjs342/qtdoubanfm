...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? ?? 12 15:26:42 2011
# Project:  ..\qjson\qjson.pro
# Template: app
# Command: c:\qtsdk\desktop\qt\4.7.4\mingw\bin\qmake.exe -spec c:\QtSDK\Desktop\Qt\4.7.4\mingw\mkspecs\win32-g++ CONFIG+=release -o Makefile ..\qjson\qjson.pro
#############################################################################
...
Makefile: ../qjson/qjson.pro  c:/QtSDK/Desktop/Qt/4.7.4/mingw/mkspecs/win32-g++/qmake.conf c:/QtSDK/Desktop/Qt/4.7.4/mingw/mkspecs/qconfig.pri \
		...
		../qjson/qxtglobalshortcut/qxtglobalshortcut.pri \
	...
	$(QMAKE) -spec c:\QtSDK\Desktop\Qt\4.7.4\mingw\mkspecs\win32-g++ CONFIG+=release -o Makefile ..\qjson\qjson.pro
